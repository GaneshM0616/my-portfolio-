...
function Header() {
  return (
    <header
      className="mt-10 w-[85%] mx-auto xl:py-2 px-3 sticky top-0  text-white bg-transparent fixed left-0 right-0 shadow-lg rounded-3xl border border-gray-300/40 backdrop-blur-lg
    sm: w-[100%] py-2"
    >
